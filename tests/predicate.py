...
class TestPredicate(unittest.TestCase):
    ...
    def test_capitalization(self):
        self.assertEquals(dogtail.predicate.makeCamel("gnome-terminal"), "gnomeTerminal")
        self.assertEquals(dogtail.predicate.makeCamel("Evolution - Mail"), "evolutionMail")
        self.assertEquals(dogtail.predicate.makeCamel('self.assertEquals(makeCamel("Evolution - Mail"), "evolutionMail")'), "selfAssertequalsMakecamelEvolutionMailEvolutionmail")
    ...
    def test_predicates_application(self):
        ...
        self.assertEquals(appPredicate.makeScriptMethodCall(True), u'application("dummy")')
    ...
    def test_predicates_window(self):
        ...
        self.assertEquals(dogtail.predicate.IsAWindow().describeSearchResult(), 'window')
    ...
    def test_predicates_window_named(self):
        ...
        self.assertEquals(frameNamedPredicate.makeScriptMethodCall(False), u'window("dummy")')
        self.assertEquals(frameNamedPredicate.makeScriptVariableName(), u'dummyWin')
    ...
    def test_predicates_menu_named(self):
        ...
        self.assertEquals(menuNamedPredicate.makeScriptMethodCall(False), u'menu("dummy", recursive=False)')
        self.assertEquals(menuNamedPredicate.makeScriptVariableName(), u'dummyMenu')
    ...
    def test_predicates_menu_item_named(self):
        ...
        self.assertEquals(menuItemNamedPredicate.makeScriptMethodCall(False), u'menuItem("dummy", recursive=False)')
        self.assertEquals(menuItemNamedPredicate.makeScriptVariableName(), u'dummyMenuItem')
    ...
    def test_predicates_text_entry_named(self):
        ...
        self.assertEquals(textNamedPredicate.makeScriptMethodCall(False), u'textentry("dummy", recursive=False)')
        self.assertEquals(textNamedPredicate.makeScriptVariableName(), u'dummyEntry')
    ...
    def test_predicates_button_named(self):
        ...
        self.assertEquals(buttonNamedPredicate.makeScriptMethodCall(False), u'button("dummy", recursive=False)')
        self.assertEquals(buttonNamedPredicate.makeScriptVariableName(), u'dummyButton')
    ...
    def test_predicates_page_tab_named(self):
        ...
        self.assertEquals(pageTabNamedPredicate.makeScriptMethodCall(False), u'tab("dummy", recursive=False)')
        self.assertEquals(pageTabNamedPredicate.makeScriptVariableName(), u'dummyTab')
    ...
    def test_predicates_named(self):
        ...
        self.assertEquals(genericNamedPredicate.makeScriptMethodCall(False), u'child(name="dummy name 1", recursive=False)')
        self.assertEquals(genericNamedPredicate.makeScriptVariableName(), u'dummyName1Node')
    ...
    def test_predicates_labelled_as(self):
        ...
        self.assertEquals(genericLabelledPredicate.makeScriptMethodCall(False), u'child(label="dummy name 1", recursive=False)')
        self.assertEquals(genericLabelledPredicate.makeScriptVariableName(), u'dummyName1Node')
